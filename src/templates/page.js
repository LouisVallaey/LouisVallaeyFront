...
export default function Page({ pageContext, data: { allStrapiPage:{edges:page}}}) {
    ...
    return (
        <Layout cta={pagedetails.heroType[0].cta} secondary={pagedetails.invertedColor}>
        {heroSection()}
        {pagedetails.heroSecond !== null ? <HeroSecond heroData={pagedetails.heroSecond} primary={pagedetails.invertedColor} /> : null }
        {pagedetails.workContent !== null ? <Work workContent={pagedetails.workContent} cta={pagedetails.heroType[0].cta} /> : null}
        </Layout>
    )
}
