    ...
    <FooterContainer secondary={secondary}>
      <ContentContainer>
        <LeftContainer secondary={!secondary}>
          <h3>
            Elk verhaal is uniek en ik help graag mee om deze verhalen vast te
            leggen
          </h3>
        ...
        <RouteContainer secondary={!secondary}>
          <RouteList>
            ...
            {pages.slice(0, 2).map((page) => (
              <RouteLink
                component={Link}
                to={page.node.link || `/${page.node.name.toLowerCase()}`}
                key={page.node.id}
              >
                {page.node.name}
              </RouteLink>
      ...
      <CreditContainer secondary={!secondary}>
        {secondary ? (
          <Logo src={logosecondary} alt="logo"></Logo>
        ) : (
          <Logo src={logoprimary} alt="logo"></Logo>
        )}
        <CreditLink>
